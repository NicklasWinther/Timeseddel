    ...
    .then((data)=> {
        ...
        data.forEach(user => { 
            ...
            user.timesedler.forEach(timeseddel => {
                ...
                workDays.push(start.format("Do MMM HH[:]mm") + " - " + end.format("HH[:]mm") + ` (${duration.hours()}:${duration.minutes().toString().padStart(2, "0")})`)
        ...
        var transporter = nodemailer.createTransport({
            service: "gmail",
            auth: {
                user: "exzentriq.timeseddel@gmail.com",
                pass: "twaxdkvamqgewgqx"
            }
        })
